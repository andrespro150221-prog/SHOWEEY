...
ContentHeader.Parent = ContentContainer
ContentHeader.BackgroundColor3 = Colors.Secondary
...
HeaderTitle.Text = "Main Features"
...
CloseButton.Parent = ContentHeader
...
local function CreateButton(name, description, callback)
    ...
    ButtonTitle.Size = UDim2.new(1, -150, 0, 25)
    ...
    ButtonDesc.Size = UDim2.new(1, -150, 0, 20)
    ButtonDesc.Font = Enum.Font.Gotham
    ButtonDesc.Text = description
    ButtonDesc.TextColor3 = Colors.TextDim
    ...
    ActionButton.Position = UDim2.new(1, -15, 0.5, 0)
    ActionButton.Size = UDim2.new(0, 100, 0, 35)
    ...
    ActionButton.MouseEnter:Connect(function()
        TweenService:Create(ActionButton, TweenInfo.new(0.2), {BackgroundColor3 = Colors.AccentHover}):Play()
    end)
    
    ActionButton.MouseLeave:Connect(function()
        TweenService:Create(ActionButton, TweenInfo.new(0.2), {BackgroundColor3 = Colors.Accent}):Play()
    end)
